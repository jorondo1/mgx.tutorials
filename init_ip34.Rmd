...
**About this guide**  
A quick guide to access ip34 (aka Mammouth)! Steps 1, 2 and 4 only need to be done once. If you need a quick primer on the bash language syntax, which is the language the code blocks below are written in, checkout Mike Lee's [awesome tutorial](https://astrobiomike.github.io/unix/unix-intro).
</div>
